 ...
 */
public class MessageReplyRemoveEvent implements Serializable {
   ...
   *
   * @return the id of the parent message for which a reply has been removed from the stream group
   */
