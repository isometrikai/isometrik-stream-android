 ...
 * AddMemberQuery} request and parse the response(both success or
 * error) to return member added result
 * AddMemberResult{@link AddMemberResult}
 * or error received.
 *
 * @see AddMemberQuery
 * @see AddMemberResult
...
public class AddMember {
  ...
  public void validateParams(@NotNull AddMemberQuery addMemberQuery,
    ...
    String userToken = addMemberQuery.getUserToken();
