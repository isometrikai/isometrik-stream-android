 ...
 * DeleteMessageQuery} request and parse the response(both success
 * or error) to return delete message result DeleteMessageResult{@link
 * DeleteMessageResult} or error received.
 *
...
public class DeleteMessage {
  ...
  public void validateParams(@NotNull DeleteMessageQuery deleteMessageQuery,
    ...
    String userToken = deleteMessageQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<DeleteMessageResult> call =
          retrofitManager.getMessageService().removeMessage(headers, queryParams);
