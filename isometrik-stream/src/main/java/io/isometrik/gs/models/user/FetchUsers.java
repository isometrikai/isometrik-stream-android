 ...
 * FetchUsersResult{@link FetchUsersResult}
 * or error received.
 *
 * @see FetchUsersQuery
...
public class FetchUsers {
  ...
  public void validateParams(@NotNull FetchUsersQuery fetchUsersQuery,
    ...
    if (searchTag != null && searchTag.isEmpty()) {
      ...
      Integer skip = fetchUsersQuery.getSkip();
      Integer limit = fetchUsersQuery.getLimit();
      ...
      Call<FetchUsersResult> call =
          retrofitManager.getUserService().fetchUsers(headers, queryParams);
