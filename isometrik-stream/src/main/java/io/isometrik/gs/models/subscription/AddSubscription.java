 ...
 * AddSubscriptionQuery{@link AddSubscriptionQuery} request and
 * parse the response(both success or error) to return add subscription result
 * AddSubscriptionResult{@link AddSubscriptionResult} or error
 * received.
 *
...
public class AddSubscription {
  ...
  public void validateParams(@NotNull AddSubscriptionQuery addSubscriptionQuery,
    ...
    String userToken = addSubscriptionQuery.getUserToken();
    Boolean streamStartChannel = addSubscriptionQuery.getStreamStartChannel();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      body.put("streamStartChannel", streamStartChannel);
