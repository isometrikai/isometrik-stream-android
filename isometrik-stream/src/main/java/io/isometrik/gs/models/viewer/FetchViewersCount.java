 ...
 * FetchViewersCountQuery} request and parse the response(both
 * success or error) to return fetch viewers count result FetchViewersCountResult{@link
 * FetchViewersCountResult} or error received.
 *
...
public class FetchViewersCount {
  ...
  public void validateParams(@NotNull FetchViewersCountQuery fetchViewersCountQuery,
    ...
    String userToken = fetchViewersCountQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchViewersCountResult> call =
          retrofitManager.getViewerService().fetchViewersCount(headers, queryParams);
