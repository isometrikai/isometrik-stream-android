 ...
 * UpdateStreamPublishingStatusResult{@link
 * UpdateStreamPublishingStatusResult}
 * or error received.
 *
...
public class UpdateStreamPublishStatus {
  ...
  public void validateParams(
    ...
    String userToken = updateStreamPublishingStatusQuery.getUserToken();

    if (userToken == null || userToken.isEmpty()) {
      completionHandler.onComplete(null, IsometrikErrorBuilder.IMERROBJ_USER_TOKEN_MISSING);
    } else if (startPublish == null) {
      completionHandler.onComplete(null, IsometrikErrorBuilder.IMERROBJ_START_PUBLISH_MISSING);
