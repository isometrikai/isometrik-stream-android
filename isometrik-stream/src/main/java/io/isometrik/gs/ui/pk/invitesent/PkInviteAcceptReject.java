 ...
 * @see CommonResponse
 */
public class PkInviteAcceptReject {

  /**
   * Validate params.
   *
   * @param pkInviteAcceptRejectQuery the fetch users request query
   ...
   * @see Gson
   */
  public void validateParams(PkInviteAcceptRejectQuery pkInviteAcceptRejectQuery,
                             @NotNull final CompletionHandler<CommonResponse> completionHandler,
                             @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
                             @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String searchTag = pkInviteAcceptRejectQuery.getSearchTag();

    if (searchTag != null && searchTag.isEmpty()) {
      completionHandler.onComplete(null, IsometrikErrorBuilder.IMERROBJ_SEARCH_TAG_INVALID_VALUE);
    } else {

      String userToken = pkInviteAcceptRejectQuery.getUserToken();
      ...
      if (userToken == null || userToken.isEmpty()) {
        ...
        bodyParams.put("inviteId", pkInviteAcceptRejectQuery.getInviteId());
        bodyParams.put("streamId", pkInviteAcceptRejectQuery.getStreamId());
        bodyParams.put("response", pkInviteAcceptRejectQuery.getResponseAction());

        Call<CommonResponse> call =
                retrofitManager.getUserService().acceptRejectPKInvite(headers, bodyParams);
