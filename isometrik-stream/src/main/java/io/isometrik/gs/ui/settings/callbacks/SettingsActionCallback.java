...
public interface SettingsActionCallback {
   ...
   * To fetch moderators
   *
   * @param streamId id of the stream for which to fetch moderators
   */
  void fetchModerators(String streamId);

  /**
   * Add moderator requested
   */
  void addModerator(ArrayList<String> moderatorIds);
