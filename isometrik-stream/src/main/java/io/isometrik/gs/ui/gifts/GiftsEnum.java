...
/**
 * The enum containing details of the gifts in various categories{@link GiftCategoryNamesEnum}.
 *
 * @see GiftCategoryNamesEnum
 */
public enum GiftsEnum {

  GIFTS_CLASSIC_URL_IMAGE1(
