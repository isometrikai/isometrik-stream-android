 ...
 * InviteUsersResponse{@link WalletResponseData}
 * or error received.
 *
 * @see FetchUsersQuery
...
public class WalletBalance {
     ...
     * Validate params.
     *
     * @param walletBalanceQuery the fetch users request query
     ...
     * @see Gson
     */
    public void validateParams(WalletBalanceQuery walletBalanceQuery,
                               @NotNull final CompletionHandler<WalletResponseData> completionHandler,
                               @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
                               @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {


        String userToken = walletBalanceQuery.getUserToken();
        String currency = walletBalanceQuery.getCurrency();
        ...
        if (userToken == null || userToken.isEmpty()) {
            ...
            Call<WalletResponseData> call =
                    retrofitManager.getWalletService().getWalletBalance(headers, queryParams);

            call.enqueue(new Callback<WalletResponseData>() {
                @Override
                public void onResponse(@NotNull Call<WalletResponseData> call,
                                       @NotNull Response<WalletResponseData> response) {
                ...
                @Override
                public void onFailure(@NotNull Call<WalletResponseData> call, @NotNull Throwable t) {
