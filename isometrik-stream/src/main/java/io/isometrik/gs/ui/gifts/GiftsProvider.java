  ...
  public static ArrayList<GiftCategoryModel> getGifts() {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      switch (i) {
        ...
        case 0:
          giftsModel = new GiftsModel(GiftsEnum.GIFTS_MOODS_URL_IMAGE1.getValue(), i,
              IsometrikStreamSdk.getInstance()
                  .getContext()
                  .getString(R.string.ism_gift_name, String.valueOf(i)));
          break;
        ...
        case 1:
          giftsModel = new GiftsModel(GiftsEnum.GIFTS_MOODS_URL_IMAGE2.getValue(), i,
              IsometrikStreamSdk.getInstance()
                  .getContext()
                  .getString(R.string.ism_gift_name, String.valueOf(i)));
        ...
        case 2:
          giftsModel = new GiftsModel(GiftsEnum.GIFTS_MOODS_URL_IMAGE3.getValue(), i,
              IsometrikStreamSdk.getInstance()
                  .getContext()
                  .getString(R.string.ism_gift_name, String.valueOf(i)));
        ...
        case 3:
          giftsModel = new GiftsModel(GiftsEnum.GIFTS_MOODS_URL_IMAGE4.getValue(), i,
              IsometrikStreamSdk.getInstance()
                  .getContext()
                  .getString(R.string.ism_gift_name, String.valueOf(i)));
        ...
        case 4:
          giftsModel = new GiftsModel(GiftsEnum.GIFTS_MOODS_URL_IMAGE5.getValue(), i,
              IsometrikStreamSdk.getInstance()
                  .getContext()
                  .getString(R.string.ism_gift_name, String.valueOf(i)));
          ...
          break;
        case 5:
          giftsModel = new GiftsModel(GiftsEnum.GIFTS_MOODS_URL_IMAGE6.getValue(), i,
              IsometrikStreamSdk.getInstance()
                  .getContext()
                  .getString(R.string.ism_gift_name, String.valueOf(i)));
          break;
        ...
        case 6:
          giftsModel = new GiftsModel(GiftsEnum.GIFTS_MOODS_URL_IMAGE7.getValue(), i,
              IsometrikStreamSdk.getInstance()
                  .getContext()
                  .getString(R.string.ism_gift_name, String.valueOf(i)));
        ...
        default:
          giftsModel = new GiftsModel(GiftsEnum.GIFTS_MOODS_URL_IMAGE8.getValue(), i,
              IsometrikStreamSdk.getInstance()
                  .getContext()
                  .getString(R.string.ism_gift_name, String.valueOf(i)));
