package io.isometrik.gs.ui.utils.shimmer;
...
public class Shimmer {
  ...
  @Retention(RetentionPolicy.SOURCE)
  @IntDef({
      Direction.LEFT_TO_RIGHT, Direction.TOP_TO_BOTTOM, Direction.RIGHT_TO_LEFT,
  ...
  public abstract static class Builder<T extends Builder<T>> {
    ...
    T consumeAttributes(TypedArray a) {
      if (a.hasValue(R.styleable.ShimmerFrameLayout_shimmer_clip_to_children)) {
        setClipToChildren(a.getBoolean(R.styleable.ShimmerFrameLayout_shimmer_clip_to_children,
      ...
      if (a.hasValue(R.styleable.ShimmerFrameLayout_shimmer_duration)) {
        setDuration(a.getInt(R.styleable.ShimmerFrameLayout_shimmer_duration,
      ...
      if (a.hasValue(R.styleable.ShimmerFrameLayout_shimmer_repeat_delay)) {
        setRepeatDelay(a.getInt(R.styleable.ShimmerFrameLayout_shimmer_repeat_delay,
      ...
      if (a.hasValue(R.styleable.ShimmerFrameLayout_shimmer_start_delay)) {
        setStartDelay(a.getInt(R.styleable.ShimmerFrameLayout_shimmer_start_delay,
      ...
      if (a.hasValue(R.styleable.ShimmerFrameLayout_shimmer_fixed_width)) {
        setFixedWidth(a.getDimensionPixelSize(R.styleable.ShimmerFrameLayout_shimmer_fixed_width,
            mShimmer.fixedWidth));
      }
      if (a.hasValue(R.styleable.ShimmerFrameLayout_shimmer_fixed_height)) {
        setFixedHeight(a.getDimensionPixelSize(R.styleable.ShimmerFrameLayout_shimmer_fixed_height,
  ...
  public static class ColorHighlightBuilder extends Builder<ColorHighlightBuilder> {
    ...
    ColorHighlightBuilder consumeAttributes(TypedArray a) {
      ...
      if (a.hasValue(R.styleable.ShimmerFrameLayout_shimmer_highlight_color)) {
        setHighlightColor(a.getColor(R.styleable.ShimmerFrameLayout_shimmer_highlight_color,
